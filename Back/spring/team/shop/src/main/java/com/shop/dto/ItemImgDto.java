...
public class ItemImgDto {
    ...
    } // map은 소스 메소드 ItemImg 엔티티를 ItemImgDto로 변환
      // map은 소스 메소드 ItemImg 소스객체를 대상클래스 (ItemImgDto.class)를 인자로 받아서 변환 수행
    // static 메소드로 선언해서 ItemImgDto를 생성하지 않아도 호출 할 수 있도록 한다

    // ModelMapper를 사용하여 ItemImg 엔티티를 ItemImgDto로 변환하는 정적 메소드
